...
#else   /* 0 */
#ifndef ALPHALCD_BITBANG
#pragma noclear                     /* do not clear __at variables at startup */
__xdata volatile unsigned char ALPHALCD_WRITE_COMMAND   __at (ALPHALCD_BASEADDR + 0);
__xdata volatile unsigned char ALPHALCD_WRITE_DATA  __at (ALPHALCD_BASEADDR + 1);
#ifdef BOC_BOARD
__xdata volatile unsigned char ALPHALCD_READ_STATUS __at (ALPHALCD_BASEADDR + 2);
__xdata volatile unsigned char ALPHALCD_READ_DATA   __at (ALPHALCD_BASEADDR + 3);
#else
#define ALPHALCD_READ_STATUS        ALPHALCD_WRITE_COMMAND
#define ALPHALCD_READ_DATA      ALPHALCD_WRITE_DATA
#endif
