...
void calc_wind_speed( unsigned char count )
{
    ...
    total_count += count;
    speed_knots = ( total_count * 22L * K ) / FILTER_SIZE;
    speed_mps = ( total_count * 11L * K ) / FILTER_SIZE;
    speed_kmph = ( total_count * 41L * K ) / FILTER_SIZE;
    speed_mph = ( total_count * 25L * K ) / FILTER_SIZE;
}
